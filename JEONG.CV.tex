...
{\bf (2026) ``{The Dynamic Effects of Cash Transfers: Evidence from Rural Liberia and Malawi}''}
with Shilpa Aggarwal, Jenny Aker, Naresh Kumar, David Sungho Park, Jonathan Robinson, and Alan Spearot. Forthcoming at \textit{AEJ: Applied}
...
with Shilpa Aggarwal, Naresh Kumar, David Sungho Park, Jonathan Robinson, and Alan Spearot. Revise and Resubmit at \textit{Economic Development and Cultural Change}
...
Seoul National University \hfill{2025} \\
...
Korean (native), English (fluent), Chinese (conversational), French (conversational), \\ Japanese (basic), Swahili (basic)
